...
@push('styles')
        <title>Arsip Documents | Surat Perintah Kerja</title>
        <!-- DataTables -->
    ...
    <div class="container-fluid">
        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h6 class="page-title">Datalist Surat Perintah Kerja</h6>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="#">Arsip Dokumen</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Surat Perintah Kerja</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">List Surat Perintah Kerja</h4>
                        <p class="card-title-desc">Berikut adalah Dokumen Surat Perintah Kerja yang berada di dalam Aplikasi.
                        </p>
