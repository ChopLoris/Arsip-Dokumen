...
@push('styles')
        <title>Arsip Documents | Surat</title>
        <!-- DataTables -->
    ...
    <div class="container-fluid">
        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h6 class="page-title">Datalist Surat</h6>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Dokumen List Surat</h4>
                        <p class="card-title-desc">Berikut adalah Dokumen Surat yang berada di dalam Aplikasi.
                        </p>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="pekerjaan" class="form-label">Nomor Surat</label>
                            <input type="text" class="form-control read-only" id="no_surat" value="" readonly>
