...
@push('styles')
        <title>Arsip Documents | Rencana Anggaran Biaya</title>
        <!-- DataTables -->
    ...
    <div class="container-fluid">
        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h6 class="page-title">Datalist Rencana Anggaran Biaya</h6>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="#">Arsip Dokumen</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Rencana Anggaran Biaya</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">List Rencana Anggaran Biaya</h4>
                        <p class="card-title-desc">Berikut adalah Rencana Anggaran Biaya yang berada di dalam Aplikasi.
                        </p>
